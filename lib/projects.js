export const projects = [
    ...
    decisions: [
      {
        ...
        body: "The site had to hold both his HR leadership work and his legal practice credibly, without either side reading as an afterthought. It was structured as distinct, clearly labeled sections rather than blended into a vague generalist profile.",
      },
      {
    ...
    decisions: [
      {
        ...
        body: "Beyond the visual design, the site was structured with search visibility in mind: clear page titles, semantic structure, real content rather than image-only sections. That way it would actually surface when someone searched for him, not just hold up once they'd already arrived.",
      },
    ],
    outcome:
  ...
  },
  {
    ...
    screenshots: [
      { src: "/pnl-app-dashboard.png", caption: "Dashboard: revenue, expenses, and net profit at a glance" },
      { src: "/pnl-app-transactions.png", caption: "Recording a transaction and browsing history" },
      { src: "/pnl-app-reports.png", caption: "Monthly closing reports with export to PDF/CSV" },
    ],
  },
  {
    ...
    decisions: [
      {
        ...
        body: "Rather than a flat, quick-and-dirty table structure, the data model was normalized early: listings, landlords, and tenant accounts as distinct, related entities. That way the system could grow without a rewrite.",
      },
      {
