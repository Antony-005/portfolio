export const insights = [
  ...
  },
  {
    ...
    body: [
      ...
      "So the interface was built around a single loop: log an entry, watch the number move. Everything else was cut or deferred until there was a real reason to add it back. Profit and loss is calculated continuously rather than at month end, which changed the tool from a record-keeping chore into something the client could glance at any time.",
